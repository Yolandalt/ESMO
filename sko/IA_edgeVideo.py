...
import numpy as np
from sko.GA import GA_EdgeVideo,GA_EdgeVideo_Y
...
class IA_TSP_Y(GA_EdgeVideo_Y):
    def __init__(self, func, best_caching_decision, n_edge, n_user,n_CNNmodel, n_dim, size_pop=50, max_iter=200, prob_mut=0.001, T=0.7, alpha=0.95):
